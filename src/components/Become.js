    ...
    <div className="bg-[#f2efed]">
      <section className="px-5 lg:px-0 mt-20  ">
        <div className="max-w-5xl shade  bg-[#FDFDFD] mx-auto grid pb-[6rem] pt-7">
          <p className="m-auto px-3 lg:text-[1.6rem] text-[2.8rem] lg:max-w-full  max-w-[52rem] font-light text-[#333333]">
        ...
        <div className="max-w-[61rem] mx-auto lg:grid-cols-1 grid grid-cols-5 items-center ">
          <div className="py-7 relative px-10 col-span-3 flex justify-between bg-[#0077B3]">
            <input
              type="text"
              placeholder="Search..."
              className="w-full bg-[#0077B3] placeholder-white font-light text-white text-[1.35rem] caret-violet-50 border-b border-white focus:outline-none"
            />
            <svg
              className=" text-white absolute right-10 top-8"
          ...
          <div className="bg-white shade col-span-2 py-7 px-5 lg:px-0 items-center flex justify-between">
            <div>
              <p className="text-[1.35rem]  text-[#0077B3]">
                About VIJ Amsterdam
              </p>
            </div>
            <svg
      ...
      <section className="-mt-10">
        <div
          className="max-w-[2080px]  mx-auto py-60"
          style={{
